        ...
        <div className="lg:col-span-2 space-y-8">
                  ...
                  {letter.attachment.startsWith('data:image/') ? (
                    <div className="relative group rounded-2xl overflow-hidden border border-slate-200 shadow-lg bg-slate-100">
                      <img 
                        ...
                        alt="Scan Surat" 
                        className={`w-full transition-all duration-300 ${showFullImage ? '' : 'max-h-96 object-top object-cover'}`}
                      />
                    </div>
                  ) : (
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <div className="text-amber-900/80 italic text-sm leading-relaxed">
              {letter.aiSummary || "Ringkasan belum di-generate."}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6 sticky top-24">
            ...
            <div className="space-y-4">
              ...
              <InfoItem icon={<GraduationCap size={18} />} label="Jenjang Pendidikan" value={letter.educationLevel || 'Umum'} />
